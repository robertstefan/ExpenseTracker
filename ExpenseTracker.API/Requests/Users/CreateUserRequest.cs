...
public record CreateUserRequest(string Username, string Email, string LastName, string FirstName, string Password) : ValidationMiddleware
{
    protected override Dictionary<string, string> Validate()
    {
        ...
        {
            errors.Add(nameof(Password), "Password must be at least 8 characters long.");
        }
